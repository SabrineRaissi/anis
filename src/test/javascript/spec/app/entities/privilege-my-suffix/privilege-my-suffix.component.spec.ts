...
import { PrivilegeMySuffixComponent } from 'app/entities/privilege-my-suffix/privilege-my-suffix.component';
...
describe('Component Tests', () => {
    describe('PrivilegeMySuffix Management Component', () => {
        let comp: PrivilegeMySuffixComponent;
        let fixture: ComponentFixture<PrivilegeMySuffixComponent>;
        let service: PrivilegeMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterrtestTestModule],
                declarations: [PrivilegeMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(PrivilegeMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(PrivilegeMySuffixComponent);
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new PrivilegeMySuffix(123)],
                        headers
                    })
                )
            );
