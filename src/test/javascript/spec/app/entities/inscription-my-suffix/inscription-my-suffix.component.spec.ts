...
import { InscriptionMySuffixComponent } from 'app/entities/inscription-my-suffix/inscription-my-suffix.component';
...
describe('Component Tests', () => {
    describe('InscriptionMySuffix Management Component', () => {
        let comp: InscriptionMySuffixComponent;
        let fixture: ComponentFixture<InscriptionMySuffixComponent>;
        let service: InscriptionMySuffixService;

        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [JhipsterrtestTestModule],
                declarations: [InscriptionMySuffixComponent],
                providers: [
                    {
                ...
                .overrideTemplate(InscriptionMySuffixComponent, '')
                .compileComponents();

            fixture = TestBed.createComponent(InscriptionMySuffixComponent);
        ...
        it('Should call load all on init', () => {
            ...
            spyOn(service, 'query').and.returnValue(
                of(
                    new HttpResponse({
                        body: [new InscriptionMySuffix(123)],
                        headers
                    })
                )
            );
